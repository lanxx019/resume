...
\item Understand Java Thread model, Actor pattern, JDBC framework, and MVC pattern. Used multiple web frameworks, such as Struts, Symfony2, and Jersey.
...
\item Interested in REST, Akka, JVM languages, and NoSQL.
\end{itemize}\par

% Experience
\addheadertext{Experience}
\starttimeline
\timelineitem{07/2013 - Now} {
    \addsubheader{Member of Techinical Staff, MongoDB, Inc.}
    \addtimelinebullet{Working in the MongoDB Management Service team.}
}
\timelinespacer
\timelineitem{04/2011 - 07/2013} {
    \addsubheader{Software Engineer, Perimeter eSecurity}
    \addtimelinebullet{Improved the legacy indexing system using Akka Actors, resulted a 30\% performance improvement.}
    ...
    \addtimelinebullet{Maintain and improve company's most profittable product, Archive Continuity portal.}
}
\timelinespacer
